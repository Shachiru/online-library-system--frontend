            ...
            <div className="w-full max-w-md bg-[#F6F6F6] rounded-3xl shadow-2xl p-8 relative overflow-hidden border-2 border-[#A2D5C6]/20">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 pl-12 border-2 rounded-xl focus:ring-2 focus:ring-[#A2D5C6]/20 focus:border-[#A2D5C6] transition-all duration-200 ${
                                    errors.email ? 'border-red-300 bg-red-50' : 'border-[#CFFFE2] bg-[#CFFFE2]/30 hover:border-[#A2D5C6]'
                                }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 pl-12 border-2 rounded-xl focus:ring-2 focus:ring-[#A2D5C6]/20 focus:border-[#A2D5C6] transition-all duration-200 ${
                                    errors.password ? 'border-red-300 bg-red-50' : 'border-[#CFFFE2] bg-[#CFFFE2]/30 hover:border-[#A2D5C6]'
                                }`}
                ...
                <div className="mt-8 text-center space-y-2">
                    <p className="text-sm text-[#000000]/60">
                        ...
                        <a href="#" className="text-[#A2D5C6] hover:text-[#CFFFE2] font-medium ml-1 transition-colors duration-200">
                            Contact Admin
                        </a>
                    </p>
