              ...
              {data.genre}
                ...
                <div className="mb-6 space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                        <div
                            className="w-8 h-8 bg-gradient-to-r from-[#B0DB9C] to-[#CAE8BD] rounded-full flex items-center justify-center">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-600">
                        <div className="flex items-center space-x-1">
                            <svg className="w-4 h-4 text-[#CAE8BD]" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
